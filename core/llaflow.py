...
from aggregate import GlobalSimilar, GSA, LocalSimilar, LSA, ShiftLSA
...
class LLAFlow(nn.Module):
    def __init__(self, args):
        super(LLAFlow, self).__init__()
        self.args = args
    ...
    def forward(self, image1, image2, iters=12, flow_init=None, upsample=True, test_mode=False):
        ...
        fmap1 = fmap1.float()
        fmap2 = fmap2.float()
        corr_fn = CorrBlock(fmap1, fmap2, self.gamma, corr2, radius=self.args.corr_radius)
